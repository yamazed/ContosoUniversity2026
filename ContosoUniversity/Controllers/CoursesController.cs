...
{
    public CoursesController(IConfiguration configuration) : base(configuration)
    {
    }
        private readonly IWebHostEnvironment _webHostEnvironment;

        public CoursesController(IConfiguration configuration, IWebHostEnvironment webHostEnvironment) : base(configuration)
        {
